    ...
    <div className='row mt-3 justify-content-center' key={post._id}>
      <div className={`card shadow-sm py-3 px-0 feed-card`}>
        <div className={`mx-3 d-flex d-row gap-2`}>
          ...
          <Image className={`my-auto rounded-circle user-profile-pic`} 
          src={post.user.profilePicUrl} onClick={handleUserProfilePicClick}
          alt="profile pic"
          height={40}
          width={40}
          />
          ...
          <div>
            <Link href={`/users/${post.user._id}`} className='p-0 mb-0 text-decoration-none'><strong>{post.user.name}</strong></Link>
        ...
        <div className='mx-auto'>
          ...
          {imageData &&
            <Image className={`w-100 mb-2 feed-card-image`}
