        ...
        <div className='row justify-content-center'>
          <div className={`card shadow-sm p-3 feed-card`}>
            <div className="row g-0">
              ...
              <Image className={`my-auto rounded-circle user-profile-pic`} alt='profile pic' width={40} height={40} src={authuserData.profilePicUrl}/>
              :
              ...
              <div className="col ms-2">
                <button className={`btn btn-light text-secondary w-100 text-start text-nowrap user-profile-pic`}
          ...
          <div className="modal-dialog">
            <form className="modal-content" encType="multipart/form-data" onSubmit={handleNewPost}>
              ...
              <div className="modal-body">
                <div className=''>
                  <label htmlFor="formTextarea" className='form-label ms-2'>Description</label>
                  <textarea className={`form-control new-post-modal-textarea`} placeholder="" id="formTextarea" required
                    onChange={(e) => setContentInput(e.target.value)}
                  />
                </div>
                <div className="mt-2">
                  <label htmlFor="formImage" className="form-label ms-2">{`Upload Image (JPG/PNG not bigger than 16Mb)`}</label>
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-primary" disabled={fileError}
                >
                  {!isLoading && 'Post'}
                  {isLoading && 
                  <div>
